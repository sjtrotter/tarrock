...
|---|---|---|---|---|
| KayKit Adventurers 1.0 (RogueHooded character + 75 embedded animations, atlas texture) | Kay Lousberg — [kaylousberg.com](https://www.kaylousberg.com) / [itch.io](https://kaylousberg.itch.io/kaykit-adventurers) | CC0 1.0 | `Assets/ThirdParty/KayKit/Adventurers/` (root files) | Legacy Fool stand-in (superseded by 2.0). CC0 requires no attribution; credited anyway. |
| KayKit Adventurers 2.0 FREE (6 characters: Knight, Barbarian, Mage, Ranger, Rogue, Rogue_Hooded; Rig_Medium animation FBXs; per-character textures) | Kay Lousberg — [kaylousberg.com](https://www.kaylousberg.com) / [itch.io](https://kaylousberg.itch.io/kaykit-adventurers) | CC0 1.0 | `Assets/ThirdParty/KayKit/Adventurers/Characters/`, `…/Animations/` | Baked-outfit characters — hex-diorama art-direction candidate. |
| KayKit Character Animations 1.1 FREE (161 humanoid animations for Rig_Medium/Rig_Large: general, movement, melee/ranged combat, simulation incl. sit/lie, tools incl. dig/fish/lockpick) | Kay Lousberg — [kaylousberg.com](https://www.kaylousberg.com) / [itch.io](https://kaylousberg.itch.io/kaykit-character-animations) | CC0 1.0 | `Assets/ThirdParty/KayKit/Adventurers/Animations/Rig_Medium/` (8 category FBXs; supersedes the 2 that shipped with Adventurers 2.0) | Drives the Adventurers rig directly — sit, dig (MQ00), and combat coverage. |
| KayKit Medieval Hexagon Pack 1.0 FREE (hex terrain tiles: grass/coast/river/road/water, hills, mountains; medieval buildings ×4 colors; decoration props; atlas texture) | Kay Lousberg — [kaylousberg.com](https://www.kaylousberg.com) / [itch.io](https://kaylousberg.itch.io/kaykit-medieval-hexagon-pack) | CC0 1.0 | `Assets/ThirdParty/KayKit/Hexagon/` | Hex-diorama world-building candidate (Unity-variant FBX). |
| KayKit Forest Nature Pack 1.0 FREE (bushes, grass, rocks, trees; color variants) | Kay Lousberg — [kaylousberg.com](https://www.kaylousberg.com) / [itch.io](https://kaylousberg.itch.io/) | CC0 1.0 | `Assets/ThirdParty/KayKit/ForestNature/` | Nature dressing matching the hex/adventurer style family. |
