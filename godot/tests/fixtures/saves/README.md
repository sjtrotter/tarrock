...
| `v1_played.json` | Three Arcana unbound plus a branch flag, a Reading, Renown in two suits, the Hermit's answer, one NPC's memory, two quest states, Trial difficulty — and the progression this bought: Trump I slotted upright in the Present, 40 Fortune, one Rose grafting taken and 2 of its 4 petals — and the `inventory` that bought it: 42 Coins, two bags of popcorn, the Reaching Head carried and fitted, and the grafting source already spent. |
